...
if __name__ == '__main__':
    ...
    print '-----------------------------------'
    print 'Flags in "%s" not in "%s".' % (options.s, options.c)
    print '-----------------------------------'
    ...
    print ''
    print '-----------------------------------'
    print 'Flags not in "%s" in "%s".' % (options.s, options.c)
    print '-----------------------------------'
    ...
    print ''
    print '-----------------------------------'
    print 'These values of "%s" and "%s" are different' % (options.s, options.c)
    print '-----------------------------------'
    for k, v in sorted(sample_conf_file_options.items()):
        if k in conf_file_options and v != conf_file_options[k]:
            # Difference value
            print '- %s = %s' % (k, v[0])
            print '+ %s = %s' % (k, conf_file_options[k][0])
